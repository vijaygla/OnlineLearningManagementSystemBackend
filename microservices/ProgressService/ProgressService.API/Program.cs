...
// Clean logging - Suppress EF command failures during sync
...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "Progress Service API", Version = "v1" });
...
app.UseSwagger();
app.UseSwaggerUI(options => { options.SwaggerEndpoint("/swagger/v1/swagger.json", "Progress Service API v1"); options.RoutePrefix = "swagger"; });
